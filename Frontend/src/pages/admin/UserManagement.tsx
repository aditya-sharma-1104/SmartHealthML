...
import { Edit2, Trash2, Shield, Search, Plus, X, UserPlus, Check, Loader2 } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white shadow border border-gray-200 sm:rounded-xl overflow-hidden">
                ...
                <div className="p-4 border-b border-gray-200 bg-gray-50 flex items-center justify-between">
                    ...
                    <span className="ml-4 text-xs text-gray-400 hidden sm:block">
                        {loading ? 'Refreshing...' : `${filteredUsers.length} result${filteredUsers.length !== 1 ? 's' : ''}`}
                    </span>
                </div>
                ...
                <div className="overflow-x-auto relative">
                    ...
                    {(users.length > 0 || !loading) && filteredUsers.length > 0 && (
